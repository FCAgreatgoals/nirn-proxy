...
func TestPaths(t *testing.T) {
	var tests = []struct {
		...
		// Channel edits too: locking channels during a raid must not queue
		// them behind one another
		{"/api/v10/channels/203039963636301824", "PATCH", "/channels/203039963636301824"},
		{"/api/v10/channels/203039963636301825", "PATCH", "/channels/203039963636301825"},
		...
		{"/api/v9/guilds/203039963636301825/channels", "GET", "/guilds/203039963636301825/channels"},
		// Wierd routes
